			...
			<div class="container-fluid">
				<div class="row bg-title">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						<h4 class="page-title">Modify Project</h4>
					</div>
				</div>
				<!-- /.row -->
				<!-- .row -->
				<div class="row">
					...
					<div class="col-md-8 col-xs-12">
						<div class="white-box">
							<form action="/helloservlet/project-modify" method="post"
								class="form-horizontal form-material"
								onsubmit="return checkDate()">
								<div class="form-group">
									<label class="col-md-12">Project Name</label>
									<div class="col-md-12">
										<input name="name" type="text" value="${projectModify.name}"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input name="start_date" type="text"
											value="${projectModify.start_date}"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
