			...
			<div class="container-fluid">
				<div class="row bg-title">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
						<a href="project-add" class="btn btn-sm btn-success">Add</a>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				<!-- /row -->
								...
								<table class="table" id="example">
									...
									<tbody>
										<c:forEach var="dataProject" items="${listProject}">
											<tr>
												<td>${dataProject.id}</td>
												<td>${dataProject.name}</td>
												<td>${dataProject.start_date}</td>
												<td>${dataProject.end_date}</td>
												<td><a
													href="/helloservlet/project-modify?id=${dataProject.id}"
													class="btn btn-sm btn-primary">Modify</a> <a
													href="/helloservlet/project-delete?id=${dataProject.id}"
													class="btn btn-sm btn-danger">Delete</a> <a
													href="/helloservlet/project-details?id=${dataProject.id}" class="btn btn-sm btn-info">View</a>
												</td>
											</tr>
										</c:forEach>
									</tbody>
