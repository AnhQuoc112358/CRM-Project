			...
			<div class="container-fluid">
				<div class="row bg-title">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						...
						<h5 class="page-title" style="color: green;font-weight: bold;">${userNow.firstname} ${userNow.lastname}</h5>
					</div>
				</div>
				<!-- /.row -->
				<!-- .row -->
						...
						<div class="white-box">
							<form class="form-horizontal form-material">
								<div class="form-group">
									...
									<div class="col-md-12">${userNow.id}</div>
								</div>
								<div class="form-group">
									<label class="col-md-12">Email</label>
									<div class="col-md-12">${userNow.email}</div>
								</div>
								<div class="form-group">
									<label class="col-md-12">Password</label>
									<div class="col-md-12">${userNow.password}</div>
								</div>
								<div class="form-group">
									<label class="col-md-12">Username</label>
									<div class="col-md-12">${userNow.username}</div>
								</div>
								<div class="form-group">
									<label class="col-md-12">Firstname</label>
									<div class="col-md-12">${userNow.firstname}</div>
								</div>
								<div class="form-group">
									<label class="col-md-12">Lastname</label>
									<div class="col-md-12">${userNow.lastname}</div>
								</div>
								<div class="form-group">
									<label class="col-md-12">Phone Number</label>
									<div class="col-md-12">${userNow.phone_number}</div>
								</div>
								<div class="form-group">
									<label class="col-md-12">Country</label>
									<div class="col-md-12">${userNow.country}</div>
								</div>
								<div class="form-group">
									<label class="col-md-12">Role</label>
									<div class="col-md-12">${userNow.role.name}</div>
								</div>
								<div class="form-group">
									<div class="col-sm-12">
										<a href="information-modify.jsp" 
										class="btn btn-sm btn-info">Modify</a>
									</div>
								</div>
							</form>
						</div>
