			...
			<div class="container-fluid">
				...
				<div class="row">
					...
					<div class="col-md-8 col-xs-12">
						<div class="white-box">
							<form action="/helloservlet/user-modify" method="post"
								class="form-horizontal form-material">
								<div class="form-group">
									<label for="example-email" class="col-md-12">Email</label>
									<div class="col-md-12">
										<input type="email" name="email" value="${userModify.email}"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="password" name="password" value="${userModify.password}"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" name="username" value="${userModify.username}"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" name="firstname" value="${userModify.firstname}"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" name="lastname" value="${userModify.lastname}"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" name="phone_number" value="${userModify.phone_number}"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" name="country" value="${userModify.country}"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<div class="col-sm-12">
										...
										<a href="user-table" class="btn btn-primary">Back</a>
									</div>
								</div>
							</form>
						</div>
