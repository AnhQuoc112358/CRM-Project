			...
			<div class="container-fluid">
				...
				<div class="row">
					...
					<div class="col-md-8 col-xs-12">
						<div class="white-box">
							<form action="/helloservlet/project-add" method="post"
								class="form-horizontal form-material"
								onsubmit="return checkDate()">
								<div class="form-group">
									<label class="col-md-12">Project Name</label>
									<div class="col-md-12">
										<input name="name" type="text" placeholder="CRM"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input name="start_date" type="text"
											placeholder="2023-10-22 (or leave it blank if not started yet.)"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input name="end_date" type="text"
											placeholder="2023-11-21 (or leave it blank if not completed.)"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-12">
										...
										<a href="project-table" class="btn btn-primary">Back</a>
									</div>
								</div>
							</form>
						</div>
