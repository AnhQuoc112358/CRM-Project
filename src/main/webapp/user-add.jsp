			...
			<div class="container-fluid">
				...
				<div class="row">
					...
					<div class="col-md-8 col-xs-12">
						<div class="white-box">
							<form action="/helloservlet/user-add" method="post"
								class="form-horizontal form-material">
								<div class="form-group">
									<label for="example-email" class="col-md-12">Email</label>
									<div class="col-md-12">
										<input type="email" name="email"
											placeholder="anhquoc112358@gmail.com"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="password" name="password" placeholder="123xyz"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" name="username" placeholder="quoc112358"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" name="firstname" placeholder="Quoc"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" name="lastname" placeholder="Nguyen Anh"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
