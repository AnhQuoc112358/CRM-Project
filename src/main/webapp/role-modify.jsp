                        ...
                        <li>
                            <div class="dropdown">
                                <a class="profile-pic dropdown-toggle" data-toggle="dropdown" href="#"> 
                                    ...
                                    <b class="hidden-xs">${userNow.username}</b> 
                                </a>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form action="/helloservlet/role-modify" method="post" class="form-horizontal form-material">
                                <div class="form-group">
                                    <label class="col-md-12">Role Name</label>
                                    <div class="col-md-12">
                                        <input type="text" name="name" value="${roleModify.name}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="description" value="${roleModify.description}" class="form-control form-control-line" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button type="submit" class="btn btn-success">Modify</button>
                                        <a href="role-table" class="btn btn-primary">Back</a>
                                    </div>
                                </div>
                            </form>
                        </div>
