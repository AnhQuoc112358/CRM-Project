						...
						<div class="col-in row">
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<h3 class="counter text-right m-t-15 text-danger">
									${percentTask.countTaskNotStarted}</h3>
							</div>
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="progress">
									<div class="progress-bar progress-bar-danger"
										...
										style="width: ${percentTask.notStarted}%">
						...
						<div class="col-in row">
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<h3 class="counter text-right m-t-15 text-megna">
									${percentTask.countTaskInProgress}</h3>
							</div>
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="progress">
									<div class="progress-bar progress-bar-megna" role="progressbar"
										aria-valuenow="${percentTask.inProgress}" aria-valuemin="0"
										aria-valuemax="100" style="width: ${percentTask.inProgress}%">
										<span class="sr-only">40% Complete (success)</span>
									</div>
								</div>
							</div>
						...
						<div class="col-in row">
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<h3 class="counter text-right m-t-15 text-primary">
									${percentTask.countTaskCompleted}</h3>
							</div>
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="progress">
									<div class="progress-bar progress-bar-primary"
										...
										aria-valuemin="0" aria-valuemax="100"
										style="width: ${percentTask.completed}%">
										<span class="sr-only">40% Complete (success)</span>
									</div>
								</div>
							</div>
