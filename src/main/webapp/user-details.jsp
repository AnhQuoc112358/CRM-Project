							...
							<div class="user-bg">
								...
								<div class="overlay-box">
									<div class="user-content">
										...
										<h4 class="text-white">${userDetails.firstname}
											${userDetails.lastname}</h4>
										<h5 class="text-white">${userDetails.email}</h5>
									</div>
								</div>
							</div>
										...
										<div class="col-md-12 col-sm-12 col-xs-12">
											<div class="progress">
												<div class="progress-bar progress-bar-danger"
													role="progressbar"
													aria-valuenow="${percentTask.notStarted}" aria-valuemin="0"
													aria-valuemax="100"
									...
									<div class="col-in row">
										<div class="col-xs-12">
											<h3 class="counter text-right m-t-15 text-megna">
												${percentTask.inProgress}%</h3>
										</div>
										<div class="col-xs-12">
											<i class="linea-icon linea-basic" data-icon="&#xe01b;"></i>
											<h5 class="text-muted vb text-center">IN PROGRESS</h5>
										</div>
										<div class="col-md-12 col-sm-12 col-xs-12">
											<div class="progress">
												<div class="progress-bar progress-bar-megna"
													role="progressbar"
													aria-valuenow="${percentTask.inProgress}" aria-valuemin="0"
													aria-valuemax="100"
						...
						<div class="white-box">
							<div class="table-responsive">
								<table class="table" id="example">
									...
									<tbody>
										<c:forEach var="dataTask" items="${listTaskByUser}">
											<tr>
												<td>${dataTask.id}</td>
												<td>${dataTask.name}</td>
												<td>${dataTask.project.name}</td>
												<td>${dataTask.start_date}</td>
												<td>${dataTask.end_date}</td>
												<td>${dataTask.status.name}</td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
