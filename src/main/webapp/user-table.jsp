			...
			<div class="container-fluid">
				<div class="row bg-title">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
						<a href="user-add" class="btn btn-sm btn-success">Add</a>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				<!-- /row -->
									...
									<tbody>
										<c:forEach var="dataUser" items="${listUser}">
											<tr>
												...
												<td><a
													href="/helloservlet/user-modify?id=${dataUser.id}"
													class="btn btn-sm btn-primary">Modify</a> <a
													href="/helloservlet/user-delete?id=${dataUser.id}"
													class="btn btn-sm btn-danger">Delete</a> <a
													href="/helloservlet/user-details?id=${dataUser.id}" 
													class="btn btn-sm btn-info">View Task</a>
												</td>
											</tr>
										</c:forEach>
									</tbody>
